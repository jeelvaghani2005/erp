...
import { DELETE_STUDENT_PROGRESS, POST_STUDENT_PROGRESS, UPDATE_STUDENT_PROGRESS } from "../../../redux-saga/student/action/action";
...
const StudentSubadmin = () => {
  ...
  const [data, setdata] = useState({
    ...
    const senddata=()=>{
        ...
        dispatch({type:UPDATE_STUDENT_PROGRESS,payload:newdata})
    }
                    ...
                    {student.map((val, index) => {
                        return (
                            <tr key={index} className="text-center">
                                ...
                                <td className="text-capitalize">{val.enrollment_number}</td>
                                ...
                                <td className="text-capitalize">
                                  ...
                                  <button onClick={()=>updatedata(val)} data-bs-toggle="modal" data-bs-target="#staticBackdrop"  className="btn update-btn ms-2" >Update</button>
                                </td>
                            </tr>
                        );
                    })}
  ...
  <div className="modal-dialog modal-lg">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-primary" onClick={senddata}>Understood</button>
      </div>
    </div>
  </div>
</div>
